  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white flex items-center justify-center px-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl max-w-md w-full text-center">
          <h1 className="text-3xl font-bold text-slate-800 mb-4">Access Required</h1>
          <p className="text-slate-600">Please use your unique invitation link to access this page.</p>
        </div>
      </div>
    );
  }
